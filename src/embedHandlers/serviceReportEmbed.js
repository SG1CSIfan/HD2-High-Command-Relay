...
function generateServiceReportEmbed(data, imageUrl, nickname) {
    ...
    return new EmbedBuilder()
        ...
        .setDescription(
            `**Mission Update**: Report submitted by Helldiver **${nickname}**.\n` +
        ...
        .addFields(
            ...
            { name: '🪖 Terminid Kills', value: `${data.terminidKills || 0}`, inline: true },
            { name: '🤖 Automaton Kills', value: `${data.automatonKills || 0}`, inline: true },
            { name: '💡 Illuminate Kills', value: `${data.illuminateKills || 0}`, inline: true },
            { name: '🧨 Friendly Kills', value: `${data.friendlyKills || 0}`, inline: true },
            { name: '☠️ Deaths', value: `${data.deaths || 0}`, inline: true },
            { name: '\u200B', value: '\u200B', inline: true },
            { name: '📸 Shots Fired', value: `${data.shotsFired || 0}`, inline: true },
            { name: '🎯 Shots Hit', value: `${data.shotsHit || 0}`, inline: true },
            { name: '\u200B', value: '\u200B', inline: true },
